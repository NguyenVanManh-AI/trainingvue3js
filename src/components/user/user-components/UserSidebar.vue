    ...
    <div
      ...
      <div id="my-scroll" style="margin: 0px 14px 0 14px;">
        <ul class="nav-list" style="overflow: visible;">
          ...
          <span>
            <li>
              <router-link class="links" data-path="category-manage" :to="{ name: 'ManageCategory' }"><i class="fa-solid fa-tag"></i><span class="links_name">Category Manage</span></router-link>
            </li>
          </span>
      ...
      <div class="profile">
        <div class="profile-details">
          <img id="avatar_sidebar" :src="user.avatar ? config.URL + user.avatar : require('@/assets/avatar.jpg')" alt="Avatar User">
          <div class="name_job">
